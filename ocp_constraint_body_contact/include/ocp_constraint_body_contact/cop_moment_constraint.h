...
class CopMomentConstraint final : public ocs2::StateInputConstraint {
 public:
  CopMomentConstraint(size_t contactIndex,
                      const ocp_solver::StateConverter<ocs2::scalar_t>& stateConverter,
                      const AssumedSurfaceContactConstraint& surfaceConstraint);

  CopMomentConstraint* clone() const override { return new CopMomentConstraint(*this); }
 ...
 private:
  CopMomentConstraint(const CopMomentConstraint& rhs);
